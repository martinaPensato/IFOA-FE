const now = new Date();
/*per salvare gli appuntamenti usiamo un array, ogni appuntamento è una stringa, ogni giorno contiene infiniti appuntamenti e ogni mese ha un numero di giorni variabile 
array padre è il mese e arrey figli i giorni. creiamo due array.*/
const appointments = [];
...
const mostraAppuntamenti = function (indiceGiorno) {
  ...
  // 5- la lsita è piena ma è ancora nascosta
  const divAppuntamenti = document.getElementById("appointments");
